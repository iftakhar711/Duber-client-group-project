            ...
            <div>
                ...
                <div className="">
                    <button
                        ...
                        className={`${inputPassword.length && checks.lesThenEightCharacter && checks.oneDigit && checks.oneLetter ? "bg-gray-900 hover:bg-gray-900 hover:cursor-pointer text-white" : "bg-gray-100 text-gray-800 cursor-not-allowed"} w-full px-4 py-2.5 mt-4 rounded-full flex items-center justify-center gap-2 hover:bg-opacity-90 transition ease-in-out duration-500 `}
